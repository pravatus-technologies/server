...
const parseTags = tags => {
  return tags.map(({
    props
  }) => Object.fromEntries(Object.entries(props).map(([key, value]) => [(0,camelcase__WEBPACK_IMPORTED_MODULE_0__["default"])(key), (0,camelcase__WEBPACK_IMPORTED_MODULE_0__["default"])(key) === 'displayName' ? String(value) : value])));
};
/**
  ...
  methods: {
    ...
    createOption(newDisplayName) {
      for (const tag of this.sortedTags) {
        ...
        if (displayName === newDisplayName && Object.entries(baseTag).every(([key, value]) => _utils_js__WEBPACK_IMPORTED_MODULE_4__.defaultBaseTag[key] === value)) {
...
/******/ })()
;
//# sourceMappingURL=files-sidebar.js.map?v=b076cee03a93f34ab179