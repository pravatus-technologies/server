...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_10__.defineComponent)({
  ...
  setup() {
     ...
     */
    const initialAppOrder = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_1__.loadState)('core', 'apps').filter(({
      type
    }) => type === 'link').map(app => ({
      ...app,
      label: app.name,
     ...
     */
    const hasAppOrderChanged = (0,vue__WEBPACK_IMPORTED_MODULE_10__.computed)(() => initialAppOrder.some(({
      id
    }, index) => id !== appOrder.value[index].id));
...
const __default__ = {
  ...
  methods: {
    ...
    debouncePickColor: debounce__WEBPACK_IMPORTED_MODULE_11___default()(function (...args) {
      this.pickColor(...args);
    }, 200),
    pickFile() {
...
/******/ })()
;
//# sourceMappingURL=theming-personal-theming.js.map?v=861946755ada7f23ae9d