...
const actions = {
   ...
   */
  async loadAllPredefinedStatuses({
    state,
    commit
  }) {
...
const mutations = {
   ...
   */
  loadBackupStatusFromServer(state, {
    status,
    statusIsUserDefined,
    message,
    icon,
...
/******/ 			return "" + chunkId + "-" + chunkId + ".js?v=" + {"node_modules_nextcloud_dialogs_dist_chunks_index-CWnkpNim_mjs":"4f23678dfbf5775f2ba6","user-status-modal":"127a8cbd9b96f4c305f1","data_image_svg_xml_3c_21--_20-_20SPDX-FileCopyrightText_202020_20Google_20Inc_20-_20SPDX-Lice-019035":"f35b3330fa0f09298524"}[chunkId] + "";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ })()
;
//# sourceMappingURL=user_status-menu.js.map?v=e2eb3b1a2d004f3c4019