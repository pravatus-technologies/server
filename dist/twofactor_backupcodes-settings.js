...
const actions = {
  generate({
    ...
    return (0,_service_BackupCodesService_js__WEBPACK_IMPORTED_MODULE_0__.generateCodes)().then(({
      codes,
      state
    }) => {
...
/******/ })()
;
//# sourceMappingURL=twofactor_backupcodes-settings.js.map?v=10c459f785894b4725f5