...
class AccountFilter extends _nextcloud_files__WEBPACK_IMPORTED_MODULE_0__.FileListFilter {
  ...
  filter(nodes) {
    ...
    const userIds = this.filterAccounts.map(({
      uid
    }) => uid);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (() => {
  ...
  Navigation.register(new _nextcloud_files__WEBPACK_IMPORTED_MODULE_1__.View({
    ...
    parent: sharesViewId,
    columns: [],
    getContents: () => (0,_services_SharingService__WEBPACK_IMPORTED_MODULE_10__.getContents)(false, true, false, false, [_nextcloud_sharing__WEBPACK_IMPORTED_MODULE_2__.ShareType.Link, _nextcloud_sharing__WEBPACK_IMPORTED_MODULE_2__.ShareType.Email]).then(({
      folder,
      contents
    }) => {
      return {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_8__.defineComponent)({
  ...
  setup(__props, {
    ...
    (0,vue__WEBPACK_IMPORTED_MODULE_8__.watch)(selectedAccounts, () => {
      ...
      const accounts = selectedAccounts.value.map(({
        id: uid,
        displayName
      }) => ({
        uid,
     ...
     */
    async function updateAvailableAccounts(path = '/') {
...
/******/ 			return "" + chunkId + "-" + chunkId + ".js?v=" + {"node_modules_nextcloud_dialogs_dist_chunks_index-CWnkpNim_mjs":"4f23678dfbf5775f2ba6","apps_files_sharing_src_models_Share_ts-apps_files_sharing_src_utils_GeneratePassword_ts-node_-14f1ab":"2d7191c507fcdb101a9b","apps_files_sharing_src_components_NewFileRequestDialog_vue":"6951972f8e570c09d612","apps_files_sharing_src_views_FilesHeaderNoteToRecipient_vue":"349405d663d25e66a9c2","node_modules_mime_dist_src_index_js":"88a8e2afeb03a14fb9bb","data_image_svg_xml_3c_21--_20-_20SPDX-FileCopyrightText_202020_20Google_20Inc_20-_20SPDX-Lice-019035":"f35b3330fa0f09298524"}[chunkId] + "";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ })()
;
//# sourceMappingURL=files_sharing-init.js.map?v=fedc5aa6aefd3cdd9da2