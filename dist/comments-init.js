...
/* harmony import */ var _mdi_svg_svg_comment_processing_svg_raw__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @mdi/svg/svg/comment-processing.svg?raw */ "./node_modules/@mdi/svg/svg/comment-processing.svg?raw");
/* harmony import */ var _logger__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../logger */ "./apps/comments/src/logger.js");
/**
 * SPDX-FileCopyrightText: 2023 Nextcloud GmbH and Nextcloud contributors
 * SPDX-License-Identifier: AGPL-3.0-or-later
 */
...
const action = new _nextcloud_files__WEBPACK_IMPORTED_MODULE_0__.FileAction({
  ...
  title(nodes) {
    ...
    if (unread >= 0) {
      return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translatePlural)('comments', '1 new comment', '{unread} new comments', unread, {
        unread
      });
    }
    return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('comments', 'Comment');
  },
  // Empty string when rendered inline
  displayName: () => '',
  iconSvgInline: () => _mdi_svg_svg_comment_processing_svg_raw__WEBPACK_IMPORTED_MODULE_2__,
  enabled(nodes) {
    const unread = nodes[0].attributes['comments-unread'];
  ...
  async exec(node) {
    try {
      ...
      _logger__WEBPACK_IMPORTED_MODULE_3__["default"].error('Error while opening sidebar', {
        error
      });
      return false;
    }
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _nextcloud_files__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @nextcloud/files */ "./node_modules/@nextcloud/files/dist/index.mjs");
/* harmony import */ var _actions_inlineUnreadCommentsAction__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./actions/inlineUnreadCommentsAction */ "./apps/comments/src/actions/inlineUnreadCommentsAction.ts");
/**
 * SPDX-FileCopyrightText: 2023 Nextcloud GmbH and Nextcloud contributors
 * SPDX-License-Identifier: AGPL-3.0-or-later
 */
...
(0,_nextcloud_files__WEBPACK_IMPORTED_MODULE_0__.registerFileAction)(_actions_inlineUnreadCommentsAction__WEBPACK_IMPORTED_MODULE_1__.action);
...
/******/ })()
;
//# sourceMappingURL=comments-init.js.map?v=0741cf6ae0879b8e76ce