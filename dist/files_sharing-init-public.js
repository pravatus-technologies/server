...
/* harmony import */ var _mdi_svg_svg_cloud_upload_svg_raw__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @mdi/svg/svg/cloud-upload.svg?raw */ "./node_modules/@mdi/svg/svg/cloud-upload.svg?raw");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (() => {
  const foldername = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_1__.loadState)('files_sharing', 'filename');
  ...
  const view = new _nextcloud_files__WEBPACK_IMPORTED_MODULE_0__.View({
    id: 'public-file-drop',
    name: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translate)('files_sharing', 'File drop'),
    caption: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translate)('files_sharing', 'Upload files to {foldername}', {
      foldername
    }),
    icon: _mdi_svg_svg_cloud_upload_svg_raw__WEBPACK_IMPORTED_MODULE_3__,
    order: 1,
    emptyView: async div => {
      if (FilesViewFileDropEmptyContent === undefined) {
        ...
        FilesViewFileDropEmptyContent = vue__WEBPACK_IMPORTED_MODULE_4__["default"].extend(component);
      }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (() => {
  const view = new _nextcloud_files__WEBPACK_IMPORTED_MODULE_0__.View({
    ...
    caption: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('files_sharing', 'Public shared file.'),
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (() => {
  const view = new _nextcloud_files__WEBPACK_IMPORTED_MODULE_1__.View({
    ...
    caption: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_0__.translate)('files_sharing', 'Public shared files.'),
...
/* harmony import */ var _nextcloud_files__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @nextcloud/files */ "./node_modules/@nextcloud/files/dist/index.mjs");
/* harmony import */ var _nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @nextcloud/initial-state */ "./node_modules/@nextcloud/initial-state/dist/index.mjs");
/* harmony import */ var _files_views_publicFileDrop_ts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./files_views/publicFileDrop.ts */ "./apps/files_sharing/src/files_views/publicFileDrop.ts");
/* harmony import */ var _files_views_publicShare_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./files_views/publicShare.ts */ "./apps/files_sharing/src/files_views/publicShare.ts");
/* harmony import */ var _files_views_publicFileShare_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./files_views/publicFileShare.ts */ "./apps/files_sharing/src/files_views/publicFileShare.ts");
/* harmony import */ var _files_src_services_RouterService__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../files/src/services/RouterService */ "./apps/files/src/services/RouterService.ts");
/* harmony import */ var _router__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./router */ "./apps/files_sharing/src/router/index.ts");
/**
 * SPDX-FileCopyrightText: 2024 Nextcloud GmbH and Nextcloud contributors
 * SPDX-License-Identifier: AGPL-3.0-or-later
 */
...
(0,_files_views_publicFileDrop_ts__WEBPACK_IMPORTED_MODULE_2__["default"])();
(0,_files_views_publicShare_ts__WEBPACK_IMPORTED_MODULE_3__["default"])();
(0,_files_views_publicFileShare_ts__WEBPACK_IMPORTED_MODULE_4__["default"])();
// Get the current view from state and set it active
const view = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_1__.loadState)('files_sharing', 'view');
const navigation = (0,_nextcloud_files__WEBPACK_IMPORTED_MODULE_0__.getNavigation)();
navigation.setActive(navigation.views.find(({
  id
}) => id === view) ?? null);
// Force our own router
window.OCP.Files = window.OCP.Files ?? {};
window.OCP.Files.Router = new _files_src_services_RouterService__WEBPACK_IMPORTED_MODULE_5__["default"](_router__WEBPACK_IMPORTED_MODULE_6__["default"]);
// If this is a single file share, so set the fileid as active in the URL
const fileId = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_1__.loadState)('files_sharing', 'fileId', null);
const token = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_1__.loadState)('files_sharing', 'sharingToken');
if (fileId !== null) {
...
vue_router__WEBPACK_IMPORTED_MODULE_3__["default"].prototype.push = function push(to, onComplete, onAbort) {
...
const router = new vue_router__WEBPACK_IMPORTED_MODULE_3__["default"]({
  ...
  stringifyQuery(query) {
    const result = query_string__WEBPACK_IMPORTED_MODULE_4__["default"].stringify(query).replace(/%2F/gmi, '/');
...
/******/ 			return "" + chunkId + "-" + chunkId + ".js?v=" + {"apps_files_sharing_src_views_FilesViewFileDropEmptyContent_vue":"6657d13be4325445f617","node_modules_nextcloud_upload_dist_chunks_ConflictPicker-D0BLWDdv_mjs":"18ac142d7cc4581e8c1e","node_modules_nextcloud_upload_node_modules_nextcloud_dialogs_dist_chunks_index-C1azEbgd_mjs":"8ef43a9bfe43c6625321","data_image_svg_xml_3c_21--_20-_20SPDX-FileCopyrightText_202020_20Google_20Inc_20-_20SPDX-Lice-cccd4a":"5fbfc71afadaeade8979"}[chunkId] + "";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ })()
;
//# sourceMappingURL=files_sharing-init-public.js.map?v=2e8ca601b2bdc2da9507