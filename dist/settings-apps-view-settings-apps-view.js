...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_4__.defineComponent)({
  ...
  setup(__props) {
    const props = __props;
    const hasChangelog = (0,vue__WEBPACK_IMPORTED_MODULE_4__.computed)(() => Object.values(props.app.releases?.[0]?.translations ?? {}).some(({
      changelog
    }) => !!changelog));
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_11__.defineComponent)({
  ...
  setup(__props) {
     ...
     */
    const isSubscribed = (0,vue__WEBPACK_IMPORTED_MODULE_11__.computed)(() => store.apps.find(({
      level
    }) => level === 300) !== undefined);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    lastModified() {
      return (this.app.appstoreData?.releases ?? []).map(({
        lastModified
      }) => Date.parse(lastModified)).sort().at(0) ?? null;
    },
    /**
...
//# sourceMappingURL=settings-apps-view-settings-apps-view.js.map?v=f859d5288e7759e84582