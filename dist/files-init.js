...
/* harmony import */ var _mdi_svg_svg_arrow_down_svg_raw__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @mdi/svg/svg/arrow-down.svg?raw */ "./node_modules/@mdi/svg/svg/arrow-down.svg?raw");
/**
 * SPDX-FileCopyrightText: 2023 Nextcloud GmbH and Nextcloud contributors
 * SPDX-License-Identifier: AGPL-3.0-or-later
 */
...
const downloadNodes = function (dir, nodes) {
  ...
  if ((0,_nextcloud_sharing_public__WEBPACK_IMPORTED_MODULE_3__.isPublicShare)()) {
    url = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_2__.generateUrl)('/s/{token}/download/{filename}?path={dir}&files={files}&downloadStartSecret={secret}', {
      dir,
      secret,
      ...
      filename: `${(0,path__WEBPACK_IMPORTED_MODULE_4__.basename)(dir)}.zip}`
    });
  } else {
    url = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_2__.generateUrl)('/apps/files/ajax/download.php?dir={dir}&files={files}&downloadStartSecret={secret}', {
      dir,
      secret,
      files: JSON.stringify(nodes.map(node => node.basename))
    });
...
const action = new _nextcloud_files__WEBPACK_IMPORTED_MODULE_0__.FileAction({
  ...
  iconSvgInline: () => _mdi_svg_svg_arrow_down_svg_raw__WEBPACK_IMPORTED_MODULE_6__,
  enabled(nodes) {
    if (nodes.length === 0) {
      return false;
    }
 ...
 */
const handleCopyMoveNodeTo = async (node, destination, method, overwrite = false) => {
  if (!destination) {
    return;
  }
  ...
  return await queue.add(async () => {
    ...
    try {
      ...
      vue__WEBPACK_IMPORTED_MODULE_12__["default"].set(node, 'status', undefined);
    }
  });
};
/**
...
class HiddenFilesFilter extends _nextcloud_files__WEBPACK_IMPORTED_MODULE_0__.FileListFilter {
  constructor() {
    ...
    (0,_nextcloud_event_bus__WEBPACK_IMPORTED_MODULE_1__.subscribe)('files:config:updated', ({
      key,
      value
    }) => {
      if (key === 'show_hidden') {
    ...
    if (presets && presets.length > 0) {
      for (const preset of presets) {
        chips.push({
          icon: preset.icon,
          text: preset.label,
          onclick: () => this.setPreset(presets.filter(({
            id
          }) => id !== preset.id))
        });
      }
...
const getTreeNodes = (tree, currentPath = '/', nodes = []) => {
...
const getFolderTreeNodes = async (path = '/', depth = 1) => {
  const {
    data: tree
...
const useUserConfigStore = function (...args) {
  ...
  if (!userConfigStore._initialized) {
    (0,_nextcloud_event_bus__WEBPACK_IMPORTED_MODULE_0__.subscribe)('files:config:updated', function ({
      key,
      value
    }) {
...
const generateFavoriteFolderView = function (folder, index = 0) {
...
const registerFavoritesView = async () => {
  ...
  Navigation.register(new _nextcloud_files__WEBPACK_IMPORTED_MODULE_1__.View({
    ...
    caption: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translate)('files', 'List of favorites files and folders.'),
...
const registerTreeChildren = async (path = '/') => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_4__.defineComponent)({
  ...
  computed: {
    ...
    currentPreset() {
      return this.timePresets.find(({
        id
      }) => id === this.selectedOption) ?? null;
    }
  },
  watch: {
    selectedOption() {
...
/******/ 			return "" + chunkId + "-" + chunkId + ".js?v=" + {"node_modules_nextcloud_dialogs_dist_chunks_index-CWnkpNim_mjs":"4f23678dfbf5775f2ba6","node_modules_nextcloud_upload_dist_chunks_ConflictPicker-D0BLWDdv_mjs":"18ac142d7cc4581e8c1e","node_modules_nextcloud_upload_node_modules_nextcloud_dialogs_dist_chunks_index-C1azEbgd_mjs":"8ef43a9bfe43c6625321","apps_files_src_views_TemplatePicker_vue-data_image_svg_xml_3c_21--_20-_20SPDX-FileCopyrightTe-15ea2e":"fb009fa6e0b89286f3bf","data_image_svg_xml_3c_21--_20-_20SPDX-FileCopyrightText_202020_20Google_20Inc_20-_20SPDX-Lice-019035":"f35b3330fa0f09298524","data_image_svg_xml_3c_21--_20-_20SPDX-FileCopyrightText_202020_20Google_20Inc_20-_20SPDX-Lice-cccd4a":"5fbfc71afadaeade8979"}[chunkId] + "";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ })()
;
//# sourceMappingURL=files-init.js.map?v=2f9c1a9b082d38a2c6a5